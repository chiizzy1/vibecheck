...
import { ArrowLeft, Play, Download, Sparkles, Hash, Zap, Clapperboard, Film } from "lucide-react";
    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-dark font-display text-slate-100">
      ...
      <main className="flex-1 px-4 lg:px-12 py-6 lg:py-8 max-w-[1600px] mx-auto w-full">
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="glassmorphism p-4 rounded-xl">
            <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mb-1">Avg Sentiment</p>
            <p className="text-xl font-bold text-primary">Positive</p>
          </div>
          <div className="glassmorphism p-4 rounded-xl border-primary/40">
            <p className="text-[10px] text-primary uppercase font-bold tracking-widest mb-1">Director Score</p>
